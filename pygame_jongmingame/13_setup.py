...
def setup_gemstone():
    ...
    gemstsone_group.add(Gemstone(gemstone_images[0], (400, 400) , small_gold_price, small_gold_speed))
    gemstsone_group.add(Gemstone(gemstone_images[0], (600, 450) , small_gold_price, small_gold_speed))
    gemstsone_group.add(Gemstone(gemstone_images[0], (800, 400) , small_gold_price, small_gold_speed))
    gemstsone_group.add(Gemstone(gemstone_images[0], (1150, 380) , small_gold_price, small_gold_speed))
    # 큰금
    gemstsone_group.add(Gemstone(gemstone_images[1], (300, 500),  big_gold_price, big_gold_speed))
    gemstsone_group.add(Gemstone(gemstone_images[1], (800, 500),  big_gold_price, big_gold_speed))
    gemstsone_group.add(Gemstone(gemstone_images[1], (700, 500),  big_gold_price, big_gold_speed))
    # 돌
    gemstsone_group.add(Gemstone(gemstone_images[2], (300, 380) ,   stone_price, stone_speed))
    gemstsone_group.add(Gemstone(gemstone_images[2], (300, 450) ,   stone_price, stone_speed))
    
    # 다이아 몬드
    gemstsone_group.add(Gemstone(gemstone_images[3], (700, 420),   diamone_price, diamond_speed ))
...
pygame.display.set_caption("종민이는 배고파")
...
background = pygame.image.load(os.path.join(current_path, "background.jpeg"))
